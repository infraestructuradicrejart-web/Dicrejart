...
const ProduccionPage = () => {
  ...
  const handleDateChange = async (e) => {
    ...
    // mañana pero quedó con el horario vespertino que tenía el 18).
    //
    // Se reinicia primero a "sin tiempo extra" (elección deliberada) y se corrige en
    ...
    // `horasExtraLimit` de TODA la empresa). Con el recorte, una autorización real de un
    // día ya programado podía no "verse" al volver a esa fecha — el formulario se quedaba
    // en blanco creyendo que no había nada, y guardar así CANCELABA la autorización real
    // de ese día (cancelPendingHorasExtra) para reemplazarla por una vacía/nueva: el "se
    // borra la información de un día previo" reportado.
